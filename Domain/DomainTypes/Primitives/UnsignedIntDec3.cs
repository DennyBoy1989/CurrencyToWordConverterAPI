...
/// <summary>
/// Primitiv domain object, that represents a number with the range 0 to 999.
/// </summary>
public class UnsignedIntDec3 {
    ...
    /// <summary>
    /// Factory method to instantiate a new <see cref="UnsignedIntDec3"/> by a given <see cref="UnsignedIntString"/> . Throws domain errors, when the given string exceeds the ranges.
    /// </summary>
